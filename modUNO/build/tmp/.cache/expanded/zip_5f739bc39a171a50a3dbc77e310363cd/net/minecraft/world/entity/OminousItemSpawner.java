...
public class OminousItemSpawner extends Entity {
    ...
    private void spawnItem() {
        ...
        if (!itemstack.isEmpty()) {
            ...
            if (itemstack.getItem() instanceof ProjectileItem projectileitem) {
                ...
                projectileitem$dispenseconfig.overrideDispenseEvent().ifPresent(p_330249_ -> level.levelEvent(p_330249_, this.blockPosition(), 0));
                entity = projectile;
            } else {
    ...
    protected void readAdditionalSaveData(CompoundTag pCompound) {
        ...
        pCompound.getLong("spawn_item_after_ticks");
    }
