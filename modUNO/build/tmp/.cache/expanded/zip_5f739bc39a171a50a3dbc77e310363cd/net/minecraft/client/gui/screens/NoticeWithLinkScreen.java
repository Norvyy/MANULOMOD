...
public class NoticeWithLinkScreen extends Screen {
    ...
    public NoticeWithLinkScreen(Component pTitle, Component pMessage, String pUrl, Runnable pOnClose) {
        super(pTitle);
    ...
    public static Screen createWorldSymlinkWarningScreen(Runnable pOnClose) {
        return new NoticeWithLinkScreen(SYMLINK_WORLD_TITLE, SYMLINK_WORLD_MESSAGE_TEXT, "https://aka.ms/MinecraftSymLinks", pOnClose);
    }

    public static Screen createPackSymlinkWarningScreen(Runnable pOnClose) {
        return new NoticeWithLinkScreen(SYMLINK_PACK_TITLE, SYMLINK_PACK_MESSAGE_TEXT, "https://aka.ms/MinecraftSymLinks", pOnClose);
    }
