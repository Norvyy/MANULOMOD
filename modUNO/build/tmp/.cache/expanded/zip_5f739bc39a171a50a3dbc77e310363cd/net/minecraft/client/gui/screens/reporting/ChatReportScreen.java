...
public class ChatReportScreen extends AbstractReportScreen<ChatReport.Builder> {
    ...
    protected void init() {
        ...
        this.selectReasonButton = Button.builder(
                SELECT_REASON, p_296210_ -> this.minecraft.setScreen(new ReportReasonSelectionScreen(this, this.reportBuilder.reason(), p_296212_ -> {
        ...
        linearlayout.addChild(Button.builder(CommonComponents.GUI_BACK, p_325396_ -> this.onClose()).width(120).build());
        this.sendButton = linearlayout.addChild(Button.builder(SEND_REPORT, p_325395_ -> this.sendReport()).width(120).build());
        this.layout.visitWidgets(p_325394_ -> {
            AbstractWidget abstractwidget = this.addRenderableWidget(p_325394_);
        });
