...
public abstract class AbstractContainerScreen<T extends AbstractContainerMenu> extends Screen implements MenuAccess<T> {
    ...
    public void render(GuiGraphics pGuiGraphics, int pMouseX, int pMouseY, float pPartialTick) {
        ...
        net.minecraftforge.client.event.ForgeEventFactoryClient.onContainerRenderBackground(this, pGuiGraphics, pMouseX, pMouseY);
        ...
        net.minecraftforge.client.event.ForgeEventFactoryClient.onContainerRenderForeground(this, pGuiGraphics, pMouseX, pMouseY);
