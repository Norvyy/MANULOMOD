...
public class Connection extends SimpleChannelInboundHandler<Packet<?>> {
    ...
    public static void configureSerialization(ChannelPipeline pPipeline, PacketFlow pFlow, boolean p_328504_, @Nullable BandwidthDebugMonitor pBandwithDebugMonitor) {
        ...
        pPipeline.addLast("splitter", createFrameDecoder(pBandwithDebugMonitor, p_328504_))
    ...
    private static ChannelInboundHandler createFrameDecoder(@Nullable BandwidthDebugMonitor pBandwithDebugMonitor, boolean p_335874_) {
        if (!p_335874_) {
