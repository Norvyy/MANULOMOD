        ...
        this.goalSelector
            .addGoal(
                ...
                new UseItemGoal<>(
                    ...
                    p_327051_ -> this.level().isNight() && !p_327051_.isInvisible()
                )
            );
        this.goalSelector
            .addGoal(
                0, new UseItemGoal<>(this, new ItemStack(Items.MILK_BUCKET), SoundEvents.WANDERING_TRADER_REAPPEARED, p_327050_ -> this.level().isDay() && p_327050_.isInvisible())
            );
