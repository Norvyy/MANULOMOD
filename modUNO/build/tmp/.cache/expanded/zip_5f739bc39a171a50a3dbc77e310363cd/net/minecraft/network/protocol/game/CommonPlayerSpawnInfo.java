...
public record CommonPlayerSpawnInfo(
    ...
    private static final StreamCodec<RegistryFriendlyByteBuf, Holder<DimensionType>> DIMENSION_TYPE_ID_STREAM_CODEC = ByteBufCodecs.holderRegistry(Registries.DIMENSION_TYPE);

    public CommonPlayerSpawnInfo(RegistryFriendlyByteBuf pBuffer) {
        this(
            DIMENSION_TYPE_ID_STREAM_CODEC.decode(pBuffer),
    ...
    public void write(RegistryFriendlyByteBuf pBuffer) {
        DIMENSION_TYPE_ID_STREAM_CODEC.encode(pBuffer, this.dimensionType);
