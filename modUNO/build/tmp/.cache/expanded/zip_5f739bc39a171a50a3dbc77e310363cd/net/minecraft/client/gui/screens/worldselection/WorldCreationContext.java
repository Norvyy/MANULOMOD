...
public record WorldCreationContext(
    ...
    public WorldCreationContext(
        WorldOptions pOptions,
        WorldDimensions pSelectedDimensions,
        ...
        this(
            pOptions,
            pWorldGenRegistries.getLayer(RegistryLayer.DIMENSIONS).registryOrThrow(Registries.LEVEL_STEM),
            pSelectedDimensions,
    ...
    public WorldCreationContext withDimensions(WorldCreationContext.DimensionsUpdater pDimensionsUpdater) {
        return new WorldCreationContext(
            this.options, this.datapackDimensions, pDimensionsUpdater.apply(this.worldgenLoadContext(), this.selectedDimensions), this.worldgenRegistries, this.dataPackResources, this.dataConfiguration
        );
    }
