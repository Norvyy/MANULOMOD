...
public class TrimMaterials {
    ...
    public static Optional<Holder.Reference<TrimMaterial>> getFromIngredient(HolderLookup.Provider pRegustries, ItemStack pIngredient) {
        return pRegustries.lookupOrThrow(Registries.TRIM_MATERIAL).listElements().filter(p_266876_ -> pIngredient.is(p_266876_.value().ingredient())).findFirst();
    }
