...
public abstract class ItemTagsProvider extends IntrinsicHolderTagsProvider<Item> {
    ...
    public ItemTagsProvider(
        ...
        super(pOutput, Registries.ITEM, pLookupProvider, p_255790_ -> p_255790_.builtInRegistryHolder().key(), modId, existingFileHelper);
    ...
    public ItemTagsProvider(
        ...
        super(pOutput, Registries.ITEM, pLookupProvider, pParentProvider, p_274765_ -> p_274765_.builtInRegistryHolder().key(), modId, existingFileHelper);
        this.blockTags = pBlockTags;
    }
