...
public class VibrationSignalParticle extends TextureSheetParticle {
    ...
    public void render(VertexConsumer pBuffer, Camera pRenderInfo, float pPartialTicks) {
        ...
        this.renderSignal(pBuffer, pRenderInfo, pPartialTicks, p_253355_ -> p_253355_.rotateY(f1).rotateX(-f2).rotateY(f));
        this.renderSignal(pBuffer, pRenderInfo, pPartialTicks, p_253351_ -> p_253351_.rotateY((float) -Math.PI + f1).rotateX(f2).rotateY(f));
    }
