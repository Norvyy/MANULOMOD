        ...
        if (rendershape != RenderShape.INVISIBLE) {
            switch (rendershape) {
                case MODEL:
                    ...
                    for (var rt : bakedmodel.getRenderTypes(pState, RandomSource.create(42), modelData))
                    this.modelRenderer
                        .renderModel(
                            pPoseStack.last(),
                            pBufferSource.getBuffer(renderType != null ? renderType : net.minecraftforge.client.RenderTypeHelper.getEntityRenderType(rt, false)),
                            pState,
                            bakedmodel,
                            f,
                            f1,
                ...
                case ENTITYBLOCK_ANIMATED:
                    ...
                    renderer.renderByItem(stack, ItemDisplayContext.NONE, pPoseStack, pBufferSource, pPackedLight, pPackedOverlay);
            }
        }
    }
