...
public class DecoratedPotPatterns {
    ...
    private static ResourceKey<String> create(String pName) {
        return ResourceKey.create(Registries.DECORATED_POT_PATTERNS, new ResourceLocation(pName));
    }

    public static ResourceLocation location(ResourceKey<String> pKey) {
        return pKey.location().withPrefix("entity/decorated_pot/");
    }

    @Nullable
    public static ResourceKey<String> getResourceKey(Item pItem) {
        return ITEM_TO_POT_TEXTURE.get(pItem);
    }

    public static String bootstrap(Registry<String> pRegistry) {
        Registry.register(pRegistry, BRICK, "decorated_pot_side");
        Registry.register(pRegistry, ANGLER, "angler_pottery_pattern");
        Registry.register(pRegistry, ARCHER, "archer_pottery_pattern");
        Registry.register(pRegistry, ARMS_UP, "arms_up_pottery_pattern");
        Registry.register(pRegistry, BLADE, "blade_pottery_pattern");
        Registry.register(pRegistry, BREWER, "brewer_pottery_pattern");
        Registry.register(pRegistry, BURN, "burn_pottery_pattern");
        Registry.register(pRegistry, DANGER, "danger_pottery_pattern");
        Registry.register(pRegistry, EXPLORER, "explorer_pottery_pattern");
        Registry.register(pRegistry, FLOW, "flow_pottery_pattern");
        Registry.register(pRegistry, FRIEND, "friend_pottery_pattern");
        Registry.register(pRegistry, GUSTER, "guster_pottery_pattern");
        Registry.register(pRegistry, HEART, "heart_pottery_pattern");
        Registry.register(pRegistry, HEARTBREAK, "heartbreak_pottery_pattern");
        Registry.register(pRegistry, HOWL, "howl_pottery_pattern");
        Registry.register(pRegistry, MINER, "miner_pottery_pattern");
        Registry.register(pRegistry, MOURNER, "mourner_pottery_pattern");
        Registry.register(pRegistry, PLENTY, "plenty_pottery_pattern");
        Registry.register(pRegistry, PRIZE, "prize_pottery_pattern");
        Registry.register(pRegistry, SCRAPE, "scrape_pottery_pattern");
        Registry.register(pRegistry, SHEAF, "sheaf_pottery_pattern");
        Registry.register(pRegistry, SHELTER, "shelter_pottery_pattern");
        Registry.register(pRegistry, SKULL, "skull_pottery_pattern");
        Registry.register(pRegistry, SNORT, "snort_pottery_pattern");
        return Registry.register(pRegistry, BASE, "decorated_pot_base");
    }
}