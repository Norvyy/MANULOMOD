...
public class VanillaBlockTagsProvider extends IntrinsicHolderTagsProvider<Block> {
    ...
    protected void addTags(HolderLookup.Provider pProvider) {
        ...
        pProvider.lookupOrThrow(Registries.BLOCK).filterElements(p_284651_ -> p_284651_.defaultBlockState().canBeReplaced()).listElementIds().forEach(intrinsictagappender::add);
