...
public class CreditsAndAttributionScreen extends Screen {
    ...
    protected void init() {
        ...
        linearlayout.addChild(
            Button.builder(ATTRIBUTION_BUTTON, ConfirmLinkScreen.confirmLink(this, "https://aka.ms/MinecraftJavaAttribution")).width(210).build()
        );
        linearlayout.addChild(
            Button.builder(LICENSES_BUTTON, ConfirmLinkScreen.confirmLink(this, "https://aka.ms/MinecraftJavaLicenses")).width(210).build()
        );
