...
public class LootItem extends LootPoolSingletonContainer {
    public static final MapCodec<LootItem> CODEC = RecordCodecBuilder.mapCodec(
        p_297034_ -> p_297034_.group(BuiltInRegistries.ITEM.holderByNameCodec().fieldOf("name").forGetter(p_297028_ -> p_297028_.item))
                .and(singletonFields(p_297034_))
                .apply(p_297034_, LootItem::new)
    );
