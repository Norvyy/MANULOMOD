...
public class LootTableProvider implements DataProvider {
    ...
    public CompletableFuture<?> run(CachedOutput pOutput) {
        return this.registries.thenCompose(p_325860_ -> this.run(pOutput, p_325860_));
    }
    ...
    private CompletableFuture<?> run(CachedOutput pOutput, HolderLookup.Provider pProvider) {
        ...
        this.getTables().forEach(p_325858_ -> p_325858_.provider().get().generate(pProvider, (p_325864_, p_325865_) -> {
