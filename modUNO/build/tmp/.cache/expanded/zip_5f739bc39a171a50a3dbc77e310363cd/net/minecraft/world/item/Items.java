...
public class Items {
    ...
    public static final Item TRIDENT = registerItem(
        "trident",
        new TridentItem(new Item.Properties().durability(250).attributes(TridentItem.createAttributes()).component(DataComponents.TOOL, TridentItem.createToolProperties()))
    );
    ...
    public static final Item FLOW_BANNER_PATTERN = registerItem(
        "flow_banner_pattern", new BannerPatternItem(BannerPatternTags.PATTERN_ITEM_FLOW, new Item.Properties().stacksTo(1).requiredFeatures(FeatureFlags.UPDATE_1_21))
    );
    public static final Item GUSTER_BANNER_PATTERN = registerItem(
        "guster_banner_pattern", new BannerPatternItem(BannerPatternTags.PATTERN_ITEM_GUSTER, new Item.Properties().stacksTo(1).requiredFeatures(FeatureFlags.UPDATE_1_21))
    );
    ...
    public static final Item GUSTER_POTTERY_SHERD = registerItem("guster_pottery_sherd", new Item(new Item.Properties().requiredFeatures(FeatureFlags.UPDATE_1_21)));
    ...
    public static final Item SCRAPE_POTTERY_SHERD = registerItem("scrape_pottery_sherd", new Item(new Item.Properties().requiredFeatures(FeatureFlags.UPDATE_1_21)));
    ...
    public static final Item OMINOUS_BOTTLE = registerItem(
        "ominous_bottle",
        new OminousBottleItem(new Item.Properties().food(Foods.OMINOUS_BOTTLE).component(DataComponents.OMINOUS_BOTTLE_AMPLIFIER, 0).requiredFeatures(FeatureFlags.UPDATE_1_21))
    );
    ...
    public static Item registerBlock(Block pBlock, UnaryOperator<Item.Properties> pPropertiesModifier) {
        return registerBlock(new BlockItem(pBlock, pPropertiesModifier.apply(new Item.Properties())));
    }
