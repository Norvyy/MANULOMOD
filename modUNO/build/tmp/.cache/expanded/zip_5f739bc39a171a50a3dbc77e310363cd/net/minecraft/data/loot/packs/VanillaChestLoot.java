...
public class VanillaChestLoot implements LootTableSubProvider {
    ...
    public void generate(HolderLookup.Provider pRegistries, BiConsumer<ResourceKey<LootTable>, LootTable.Builder> pGenerator) {
        ...
        pGenerator.accept(BuiltInLootTables.BASTION_BRIDGE, bastionBridgeLootTable());
        pGenerator.accept(BuiltInLootTables.BASTION_HOGLIN_STABLE, bastionHoglinStableLootTable());
        pGenerator.accept(BuiltInLootTables.BASTION_OTHER, bastionOtherLootTable());
        pGenerator.accept(BuiltInLootTables.BASTION_TREASURE, bastionTreasureLootTable());
        pGenerator.accept(
        ...
        pGenerator.accept(BuiltInLootTables.ANCIENT_CITY, ancientCityLootTable());
        pGenerator.accept(
        ...
        pGenerator.accept(BuiltInLootTables.DESERT_PYRAMID, desertPyramidLootTable());
        pGenerator.accept(BuiltInLootTables.END_CITY_TREASURE, endCityTreasureLootTable());
        pGenerator.accept(
        ...
        pGenerator.accept(BuiltInLootTables.JUNGLE_TEMPLE, jungleTempleLootTable());
        pGenerator.accept(
        ...
        pGenerator.accept(BuiltInLootTables.NETHER_BRIDGE, netherBridgeLootTable());
        pGenerator.accept(BuiltInLootTables.PILLAGER_OUTPOST, pillagerOutpostLootTable());
        pGenerator.accept(BuiltInLootTables.SHIPWRECK_MAP, shipwreckMapLootTable());
        pGenerator.accept(BuiltInLootTables.SHIPWRECK_SUPPLY, shipwreckSupplyLootTable());
        pGenerator.accept(BuiltInLootTables.SHIPWRECK_TREASURE, shipwreckTreasureLootTable());
        pGenerator.accept(
        ...
        pGenerator.accept(BuiltInLootTables.STRONGHOLD_CORRIDOR, strongholdCorridorLootTable());
        pGenerator.accept(
        ...
        pGenerator.accept(BuiltInLootTables.STRONGHOLD_LIBRARY, strongholdLibraryLootTable());
        pGenerator.accept(
        ...
        pGenerator.accept(BuiltInLootTables.WOODLAND_MANSION, woodlandMansionLootTable());
        pGenerator.accept(
        ...
        pGenerator.accept(BuiltInLootTables.TRIAL_CHAMBERS_REWARD, LootTable.lootTable());
        pGenerator.accept(BuiltInLootTables.TRIAL_CHAMBERS_REWARD_COMMON, LootTable.lootTable());
        pGenerator.accept(BuiltInLootTables.TRIAL_CHAMBERS_REWARD_RARE, LootTable.lootTable());
        pGenerator.accept(BuiltInLootTables.TRIAL_CHAMBERS_REWARD_UNIQUE, LootTable.lootTable());
        pGenerator.accept(BuiltInLootTables.TRIAL_CHAMBERS_REWARD_OMINOUS, LootTable.lootTable());
        pGenerator.accept(BuiltInLootTables.TRIAL_CHAMBERS_REWARD_OMINOUS_COMMON, LootTable.lootTable());
        pGenerator.accept(BuiltInLootTables.TRIAL_CHAMBERS_REWARD_OMINOUS_RARE, LootTable.lootTable());
        pGenerator.accept(BuiltInLootTables.TRIAL_CHAMBERS_REWARD_OMINOUS_UNIQUE, LootTable.lootTable());
        pGenerator.accept(BuiltInLootTables.TRIAL_CHAMBERS_SUPPLY, LootTable.lootTable());
        pGenerator.accept(BuiltInLootTables.TRIAL_CHAMBERS_CORRIDOR, LootTable.lootTable());
        pGenerator.accept(BuiltInLootTables.TRIAL_CHAMBERS_ENTRANCE, LootTable.lootTable());
        pGenerator.accept(BuiltInLootTables.TRIAL_CHAMBERS_INTERSECTION, LootTable.lootTable());
        pGenerator.accept(BuiltInLootTables.TRIAL_CHAMBERS_INTERSECTION_BARREL, LootTable.lootTable());
        pGenerator.accept(BuiltInLootTables.TRIAL_CHAMBERS_CHAMBER_DISPENSER, LootTable.lootTable());
        pGenerator.accept(BuiltInLootTables.TRIAL_CHAMBERS_CORRIDOR_DISPENSER, LootTable.lootTable());
        pGenerator.accept(BuiltInLootTables.TRIAL_CHAMBERS_WATER_DISPENSER, LootTable.lootTable());
        pGenerator.accept(BuiltInLootTables.TRIAL_CHAMBERS_CORRIDOR_POT, LootTable.lootTable());
        spawnerLootTables(pGenerator);
    }

    public static void spawnerLootTables(BiConsumer<ResourceKey<LootTable>, LootTable.Builder> pOutput) {
        pOutput.accept(BuiltInLootTables.SPAWNER_TRIAL_CHAMBER_KEY, LootTable.lootTable());
        pOutput.accept(BuiltInLootTables.SPAWNER_TRIAL_CHAMBER_CONSUMABLES, LootTable.lootTable());
        pOutput.accept(BuiltInLootTables.SPAWNER_OMINOUS_TRIAL_CHAMBER_KEY, LootTable.lootTable());
        pOutput.accept(BuiltInLootTables.SPAWNER_OMINOUS_TRIAL_CHAMBER_CONSUMABLES, LootTable.lootTable());
        pOutput.accept(BuiltInLootTables.SPAWNER_TRIAL_ITEMS_TO_DROP_WHEN_OMINOUS, LootTable.lootTable());
    }
        ...
        return LootTable.lootTable()
            .withPool(
                LootPool.lootPool()
                    ...
                    .add(LootItem.lootTableItem(Items.COMPASS))
                    .add(
                        LootItem.lootTableItem(Items.BOOK).setWeight(10).apply(EnchantWithLevelsFunction.enchantWithLevels(ConstantValue.exactly(30.0F)).allowTreasure())
                    )
            )
