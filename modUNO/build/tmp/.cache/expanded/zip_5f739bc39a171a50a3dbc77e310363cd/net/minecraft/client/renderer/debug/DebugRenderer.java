...
public class DebugRenderer {
    ...
    public static void renderFilledUnitCube(
        PoseStack pPoseStack, MultiBufferSource pBuffer, BlockPos pPos, float pRed, float pGreen, float pBlue, float pAlpha
    ) {
        renderFilledBox(pPoseStack, pBuffer, pPos, pPos.offset(1, 1, 1), pRed, pGreen, pBlue, pAlpha);
    }
    ...
    public static void renderFloatingText(PoseStack pPoseStack, MultiBufferSource pBuffer, String pText, int pX, int pY, int pZ, int pColor) {
        renderFloatingText(pPoseStack, pBuffer, pText, (double)pX + 0.5, (double)pY + 0.5, (double)pZ + 0.5, pColor);
    }

    public static void renderFloatingText(
        PoseStack pPoseStack, MultiBufferSource pBuffer, String pText, double pX, double pY, double pZ, int pColor
    ) {
