...
public class LoadingOverlay extends Overlay {
    ...
    public void render(GuiGraphics pGuiGraphics, int pMouseX, int pMouseY, float pPartialTick) {
        ...
        int j2 = (int)((double)pGuiGraphics.guiWidth() * 0.5);
        int k2 = (int)((double)pGuiGraphics.guiHeight() * 0.5);
        double d1 = Math.min((double)pGuiGraphics.guiWidth() * 0.75, (double)pGuiGraphics.guiHeight()) * 0.25;
        int i1 = (int)(d1 * 0.5);
        double d0 = d1 * 4.0;
        int j1 = (int)(d0 * 0.5);
        ...
        int k1 = (int)((double)pGuiGraphics.guiHeight() * 0.8325);
