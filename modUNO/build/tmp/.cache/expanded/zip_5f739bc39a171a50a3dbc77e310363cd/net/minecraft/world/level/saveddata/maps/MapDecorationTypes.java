...
public class MapDecorationTypes {
    ...
    private static Holder<MapDecorationType> register(
        ...
        ResourceKey<MapDecorationType> resourcekey = ResourceKey.create(Registries.MAP_DECORATION_TYPE, new ResourceLocation(pName));
        MapDecorationType mapdecorationtype = new MapDecorationType(new ResourceLocation(pAssetId), pShowOnItemFrame, pMapColor, pTrackCount, pExplorationMapElement);
