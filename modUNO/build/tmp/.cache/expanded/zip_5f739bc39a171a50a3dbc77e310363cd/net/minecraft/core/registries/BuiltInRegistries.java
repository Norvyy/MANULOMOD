...
public class BuiltInRegistries {
    ...
    private static <T, R extends WritableRegistry<T>> R internalRegister(
        ...
        Bootstrap.checkBootstrapCalled(() -> "registry " + pKey);
    ...
    private static <T extends Registry<?>> void validate(Registry<T> pRegistry) {
        pRegistry.forEach(p_325821_ -> {
            if (p_325821_.keySet().isEmpty()) {
                Util.logAndPauseIfInIde("Registry '" + pRegistry.getKey((T)p_325821_) + "' was empty after loading");
            }
