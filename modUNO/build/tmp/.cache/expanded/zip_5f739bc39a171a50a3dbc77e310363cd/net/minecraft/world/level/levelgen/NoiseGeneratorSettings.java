...
public record NoiseGeneratorSettings(
    ...
    public static NoiseGeneratorSettings end(BootstrapContext<?> pContext) {
    ...
    public static NoiseGeneratorSettings nether(BootstrapContext<?> pContext) {
        return new NoiseGeneratorSettings(
    ...
    public static NoiseGeneratorSettings overworld(BootstrapContext<?> pContext, boolean pLarge, boolean pAmplified) {
        return new NoiseGeneratorSettings(
    ...
    public static NoiseGeneratorSettings caves(BootstrapContext<?> pContext) {
        return new NoiseGeneratorSettings(
    ...
    public static NoiseGeneratorSettings floatingIslands(BootstrapContext<?> pContext) {
        return new NoiseGeneratorSettings(
