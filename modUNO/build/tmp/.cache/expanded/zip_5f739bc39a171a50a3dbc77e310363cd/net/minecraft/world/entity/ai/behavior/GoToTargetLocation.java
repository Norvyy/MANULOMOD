    ...
    public static <E extends Mob> OneShot<E> create(MemoryModuleType<BlockPos> pLocationMemory, int pCloseEnoughDist, float pSpeedModifier) {
        return BehaviorBuilder.create(
            p_259997_ -> p_259997_.group(
                    ...
                    .apply(p_259997_, (p_259831_, p_259115_, p_259521_, p_259223_) -> (p_326823_, p_326824_, p_326825_) -> {
                            BlockPos blockpos = p_259997_.get(p_259831_);
                            boolean flag = blockpos.closerThan(p_326824_.blockPosition(), (double)pCloseEnoughDist);
                            if (!flag) {
                                BehaviorUtils.setWalkAndLookTargetMemories(p_326824_, getNearbyPos(p_326824_, blockpos), pSpeedModifier, pCloseEnoughDist);
                            }
