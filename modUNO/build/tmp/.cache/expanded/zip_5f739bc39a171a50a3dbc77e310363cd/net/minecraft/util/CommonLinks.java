...
public class CommonLinks {
    ...
    public static String extendRealms(String pSubscriptionId, UUID pProfileId, boolean pIsTrial) {
        return extendRealms(pSubscriptionId, pProfileId) + "&ref=" + (pIsTrial ? "expiredTrial" : "expiredRealm");
    }

    public static String extendRealms(String pSubscriptionId, UUID pProfileId) {
        return "https://aka.ms/ExtendJavaRealms?subscriptionId=" + pSubscriptionId + "&profileId=" + UndashedUuid.toString(pProfileId);
    }
}