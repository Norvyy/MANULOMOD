        ...
        protected void handleDataMarker(String pName, BlockPos pPos, ServerLevelAccessor pLevel, RandomSource pRandom, BoundingBox pBox) {
            if (pName.startsWith("Chest")) {
                ...
                if (pBox.isInside(blockpos)) {
                    RandomizableContainer.setBlockEntityLootTable(pLevel, pRandom, blockpos, BuiltInLootTables.END_CITY_TREASURE);
                }
                ...
                if (pName.startsWith("Sentry")) {
                    ...
                    if (shulker != null) {
                        shulker.setPos((double)pPos.getX() + 0.5, (double)pPos.getY(), (double)pPos.getZ() + 0.5);
