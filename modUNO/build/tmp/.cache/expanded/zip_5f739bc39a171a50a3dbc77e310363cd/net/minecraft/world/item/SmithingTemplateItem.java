...
public class SmithingTemplateItem extends Item {
    ...
    public SmithingTemplateItem(
        ...
        Component pBaseSlorDescription,
        ...
        this.baseSlotDescription = pBaseSlorDescription;
    ...
    public static SmithingTemplateItem createArmorTrimTemplate(ResourceKey<TrimPattern> pKey, FeatureFlag... pRequiredFeatures) {
        return createArmorTrimTemplate(pKey.location(), pRequiredFeatures);
    }

    public static SmithingTemplateItem createArmorTrimTemplate(ResourceLocation pName, FeatureFlag... pRequiredFeatures) {
        return new SmithingTemplateItem(
            ARMOR_TRIM_APPLIES_TO,
            ARMOR_TRIM_INGREDIENTS,
            Component.translatable(Util.makeDescriptionId("trim_pattern", pName)).withStyle(TITLE_FORMAT),
