...
public class ItemParser {
    ...
    public ItemParser.ItemResult parse(StringReader pReader) throws CommandSyntaxException {
        ...
        validateComponents(pReader, holder, datacomponentmap);
        return new ItemParser.ItemResult(holder, datacomponentmap);
    }

    private static void validateComponents(StringReader pReader, Holder<Item> pItem, DataComponentMap pComponents) throws CommandSyntaxException {
        DataComponentMap datacomponentmap = DataComponentMap.composite(pItem.value().components(), pComponents);
