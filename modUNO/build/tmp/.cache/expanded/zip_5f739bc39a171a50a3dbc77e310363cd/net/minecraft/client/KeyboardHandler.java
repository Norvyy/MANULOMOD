            ...
            if (screen != null) {
                ...
                Screen.wrapScreenError(() -> {
                    if (pAction == 1 || pAction == 2) {
                        ...
                        net.minecraftforge.client.ForgeHooksClient.onScreenKeyPressed(aboolean, screen, pKey, pScanCode, pModifiers);
                    } else if (pAction == 0) {
                        net.minecraftforge.client.ForgeHooksClient.onScreenKeyReleased(aboolean, screen, pKey, pScanCode, pModifiers);
                    }
        ...
        if (pWindowPointer == this.minecraft.getWindow().getWindow()) {
            ...
            if (guieventlistener != null && this.minecraft.getOverlay() == null) {
                if (Character.charCount(pCodePoint) == 1) {
                    Screen.wrapScreenError(
                        () -> net.minecraftforge.client.ForgeHooksClient.onScreenCharTyped(guieventlistener, (char)pCodePoint, pModifiers), "charTyped event handler", guieventlistener.getClass().getCanonicalName()
                    );
                } else {
                    for (char c0 : Character.toChars(pCodePoint)) {
                        Screen.wrapScreenError(() -> net.minecraftforge.client.ForgeHooksClient.onScreenCharTyped(guieventlistener, c0, pModifiers), "charTyped event handler", guieventlistener.getClass().getCanonicalName());
                    }
                }
            }
        }
