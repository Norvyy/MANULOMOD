...
public class SmithingTrimRecipe implements SmithingRecipe {
    ...
    public ItemStack assemble(Container pCraftingContainer, HolderLookup.Provider pRegistries) {
        ItemStack itemstack = pCraftingContainer.getItem(1);
        if (this.base.test(itemstack)) {
            Optional<Holder.Reference<TrimMaterial>> optional = TrimMaterials.getFromIngredient(pRegistries, pCraftingContainer.getItem(2));
            Optional<Holder.Reference<TrimPattern>> optional1 = TrimPatterns.getFromTemplate(pRegistries, pCraftingContainer.getItem(0));
