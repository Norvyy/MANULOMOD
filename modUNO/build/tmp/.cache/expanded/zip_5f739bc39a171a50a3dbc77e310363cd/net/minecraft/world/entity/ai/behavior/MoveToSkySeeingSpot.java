...
public class MoveToSkySeeingSpot {
    public static OneShot<LivingEntity> create(float pSpeedModifier) {
        return BehaviorBuilder.create(
            p_258543_ -> p_258543_.group(p_258543_.absent(MemoryModuleType.WALK_TARGET)).apply(p_258543_, p_258545_ -> (p_326870_, p_326871_, p_326872_) -> {
                        if (p_326870_.canSeeSky(p_326871_.blockPosition())) {
                            return false;
                        } else {
                            Optional<Vec3> optional = Optional.ofNullable(getOutdoorPosition(p_326870_, p_326871_));
