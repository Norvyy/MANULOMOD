...
public class Pufferfish extends AbstractFish {
    ...
    int inflateCounter;
    int deflateTimer;
    private static final Predicate<LivingEntity> SCARY_MOB = p_326980_ -> {
        if (p_326980_ instanceof Player player && player.isCreative()) {
            return false;
        }

        return !p_326980_.getType().is(EntityTypeTags.NOT_SCARY_FOR_PUFFERFISH);
    };
