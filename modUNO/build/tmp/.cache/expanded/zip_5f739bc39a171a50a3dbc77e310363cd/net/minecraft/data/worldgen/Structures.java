...
public class Structures {
    ...
    public static void bootstrap(BootstrapContext<Structure> pContext) {
        ...
        pContext.register(BuiltinStructures.IGLOO, new IglooStructure(structure(holdergetter.getOrThrow(BiomeTags.HAS_IGLOO), TerrainAdjustment.NONE)));
        pContext.register(
        ...
        pContext.register(BuiltinStructures.END_CITY, new EndCityStructure(structure(holdergetter.getOrThrow(BiomeTags.HAS_END_CITY), TerrainAdjustment.NONE)));
        pContext.register(
