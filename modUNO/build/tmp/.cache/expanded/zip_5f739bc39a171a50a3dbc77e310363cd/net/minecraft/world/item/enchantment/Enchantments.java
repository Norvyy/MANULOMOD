...
public class Enchantments {
    ...
    public static final Enchantment RESPIRATION = register(
        "respiration",
        new Enchantment(Enchantment.definition(ItemTags.HEAD_ARMOR_ENCHANTABLE, 2, 3, Enchantment.dynamicCost(10, 10), Enchantment.dynamicCost(40, 10), 4, ARMOR_SLOTS))
    );
    public static final Enchantment AQUA_AFFINITY = register(
        "aqua_affinity", new Enchantment(Enchantment.definition(ItemTags.HEAD_ARMOR_ENCHANTABLE, 2, 1, Enchantment.constantCost(1), Enchantment.constantCost(41), 4, ARMOR_SLOTS))
    );
    public static final Enchantment THORNS = register(
        "thorns",
        new ThornsEnchantment(
            Enchantment.definition(ItemTags.ARMOR_ENCHANTABLE, ItemTags.CHEST_ARMOR_ENCHANTABLE, 1, 3, Enchantment.dynamicCost(10, 20), Enchantment.dynamicCost(60, 20), 8, ARMOR_SLOTS)
        )
    );
    public static final Enchantment DEPTH_STRIDER = register(
        "depth_strider",
        new WaterWalkerEnchantment(Enchantment.definition(ItemTags.FOOT_ARMOR_ENCHANTABLE, 2, 3, Enchantment.dynamicCost(10, 10), Enchantment.dynamicCost(25, 10), 4, ARMOR_SLOTS))
    );
    ...
    public static final Enchantment BINDING_CURSE = register(
        "binding_curse",
        new BindingCurseEnchantment(Enchantment.definition(ItemTags.EQUIPPABLE_ENCHANTABLE, 1, 1, Enchantment.constantCost(25), Enchantment.constantCost(50), 8, ARMOR_SLOTS))
    );
    ...
    public static final Enchantment SHARPNESS = register(
        ...
        new DamageEnchantment(
            Enchantment.definition(
                ItemTags.SHARP_WEAPON_ENCHANTABLE, ItemTags.SWORD_ENCHANTABLE, 10, 5, Enchantment.dynamicCost(1, 11), Enchantment.dynamicCost(21, 11), 1, EquipmentSlot.MAINHAND
            ),
            Optional.empty()
        )
    );
    ...
    public static final Enchantment KNOCKBACK = register(
        "knockback",
        new Enchantment(Enchantment.definition(ItemTags.SWORD_ENCHANTABLE, 5, 2, Enchantment.dynamicCost(5, 20), Enchantment.dynamicCost(55, 20), 2, EquipmentSlot.MAINHAND))
    );
    ...
    public static final Enchantment SWEEPING_EDGE = register(
        "sweeping_edge",
        new Enchantment(Enchantment.definition(ItemTags.SWORD_ENCHANTABLE, 2, 3, Enchantment.dynamicCost(5, 9), Enchantment.dynamicCost(20, 9), 4, EquipmentSlot.MAINHAND))
    );
    ...
    public static final Enchantment LURE = register(
        "lure",
        new Enchantment(Enchantment.definition(ItemTags.FISHING_ENCHANTABLE, 2, 3, Enchantment.dynamicCost(15, 9), Enchantment.dynamicCost(65, 9), 4, EquipmentSlot.MAINHAND))
    );
    public static final Enchantment LOYALTY = register(
        "loyalty",
        new Enchantment(Enchantment.definition(ItemTags.TRIDENT_ENCHANTABLE, 5, 3, Enchantment.dynamicCost(12, 7), Enchantment.constantCost(50), 2, EquipmentSlot.MAINHAND))
    );
    ...
    public static final Enchantment CHANNELING = register(
        "channeling",
        new Enchantment(Enchantment.definition(ItemTags.TRIDENT_ENCHANTABLE, 1, 1, Enchantment.constantCost(25), Enchantment.constantCost(50), 8, EquipmentSlot.MAINHAND))
    );
    ...
    public static final Enchantment QUICK_CHARGE = register(
        "quick_charge",
        new Enchantment(Enchantment.definition(ItemTags.CROSSBOW_ENCHANTABLE, 5, 3, Enchantment.dynamicCost(12, 20), Enchantment.constantCost(50), 2, EquipmentSlot.MAINHAND))
    );
