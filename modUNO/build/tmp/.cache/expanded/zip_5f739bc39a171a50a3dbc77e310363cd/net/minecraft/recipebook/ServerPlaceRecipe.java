...
public class ServerPlaceRecipe<C extends Container> implements PlaceRecipe<Integer> {
    ...
    public void recipeClicked(ServerPlayer pPlayer, @Nullable RecipeHolder<? extends Recipe<C>> pRecipe, boolean pPlaceAll) {
        if (pRecipe != null && pPlayer.getRecipeBook().contains(pRecipe)) {
            ...
            if (this.testClearGrid() || pPlayer.isCreative()) {
                ...
                if (this.stackedContents.canCraft((Recipe<?>)pRecipe.value(), null)) {
    ...
    protected void handleRecipeClicked(RecipeHolder<? extends Recipe<C>> pRecipe, boolean pPlaceAll) {
        ...
        if (this.stackedContents.canCraft((Recipe<?>)pRecipe.value(), intlist, j1)) {
            int k = j1;
            ...
            if (this.stackedContents.canCraft((Recipe<?>)pRecipe.value(), intlist, k)) {
                this.clearGrid();
