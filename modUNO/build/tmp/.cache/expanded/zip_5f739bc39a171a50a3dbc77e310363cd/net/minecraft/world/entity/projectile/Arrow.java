...
public class Arrow extends AbstractArrow {
    ...
    public Arrow(Level pLevel, double pX, double pY, double pZ, ItemStack pPickupItemStack) {
        super(EntityType.ARROW, pX, pY, pZ, pLevel, pPickupItemStack);
        this.updateColor();
    }

    public Arrow(Level pLevel, LivingEntity pOwner, ItemStack pPickupItemStack) {
