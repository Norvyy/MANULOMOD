...
public class PoolElementStructurePiece extends StructurePiece {
    ...
    public PoolElementStructurePiece(
        StructureTemplateManager pStructureTemplateManager, StructurePoolElement pElement, BlockPos pPosition, int pGroundLevelDelta, Rotation pRotation, BoundingBox pBox
    ) {
    ...
    protected void addAdditionalSaveData(StructurePieceSerializationContext pContext, CompoundTag pTag) {
        ...
        StructurePoolElement.CODEC
            ...
            .resultOrPartial(LOGGER::error)
            .ifPresent(p_163125_ -> pTag.put("pool_element", p_163125_));
