    ...
    public void sendChanges() {
        ...
        if (!list.equals(this.lastPassengers)) {
            ...
            removedPassengers(list, this.lastPassengers)
                .forEach(
                    p_326429_ -> {
                        if (p_326429_ instanceof ServerPlayer serverplayer1) {
        ...
        if (this.tickCount % this.updateInterval == 0 || this.entity.hasImpulse || this.entity.getEntityData().isDirty()) {
            if (this.entity.isPassenger()) {
                ...
                boolean flag4 = this.positionCodec.delta(vec3).lengthSqr() >= 7.6293945E-6F;
                Packet<?> packet1 = null;
                ...
                if ((this.trackDelta || this.entity.hasImpulse || this.entity instanceof LivingEntity && ((LivingEntity)this.entity).isFallFlying())
                    ...
                    if (d0 > 1.0E-7 || d0 > 0.0 && vec31.lengthSqr() == 0.0) {
                        this.ap = vec31;
