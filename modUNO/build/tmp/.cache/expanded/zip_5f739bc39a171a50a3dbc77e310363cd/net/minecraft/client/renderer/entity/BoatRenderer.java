...
public class BoatRenderer extends EntityRenderer<Boat> {
        ...
        this.boatResources = Stream.of(Boat.Type.values())
            .collect(
                ImmutableMap.toImmutableMap(
                    ...
                    p_247941_ -> Pair.of(new ResourceLocation(getTextureLocation(p_247941_, pChestBoat)), this.createBoatModel(pContext, p_247941_, pChestBoat))
                )
            );
    }
    ...
    public ResourceLocation getTextureLocation(Boat pEntity) {
        return this.boatResources.get(pEntity.getVariant()).getFirst();
    }
