...
public class BannerPatternTagsProvider extends TagsProvider<BannerPattern> {
    ...
    public BannerPatternTagsProvider(PackOutput pOutput, CompletableFuture<HolderLookup.Provider> pProvider, String modId, @org.jetbrains.annotations.Nullable net.minecraftforge.common.data.ExistingFileHelper existingFileHelper) {
        super(pOutput, Registries.BANNER_PATTERN, pProvider, modId, existingFileHelper);
    }
