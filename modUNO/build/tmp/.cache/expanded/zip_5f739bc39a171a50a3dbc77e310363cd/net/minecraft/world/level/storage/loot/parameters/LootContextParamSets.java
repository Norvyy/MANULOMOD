...
public class LootContextParamSets {
    ...
    public static final LootContextParamSet CHEST = register(
        "chest", p_327636_ -> p_327636_.required(LootContextParams.ORIGIN).optional(LootContextParams.THIS_ENTITY).optional(LootContextParams.KILLER_ENTITY) //Forge: Chest Minecarts can have killers.
    );
    ...
    public static final LootContextParamSet FISHING = register(
        "fishing", p_81446_ -> p_81446_.required(LootContextParams.ORIGIN).required(LootContextParams.TOOL).optional(LootContextParams.THIS_ENTITY).optional(LootContextParams.KILLER_ENTITY).optional(LootContextParams.THIS_ENTITY) //Forge: Allow fisher, and bobber
    );
