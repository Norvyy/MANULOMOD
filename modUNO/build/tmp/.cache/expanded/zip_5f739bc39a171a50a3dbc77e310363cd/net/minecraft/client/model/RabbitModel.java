    ...
    public void renderToBuffer(
        ...
        if (this.young) {
            ...
            ImmutableList.of(this.head, this.leftEar, this.rightEar, this.nose)
                .forEach(p_103597_ -> p_103597_.render(pPoseStack, pBuffer, pPackedLight, pPackedOverlay, pRed, pGreen, pBlue, pAlpha));
            pPoseStack.popPose();
            pPoseStack.pushPose();
            ...
            ImmutableList.of(this.leftRearFoot, this.rightRearFoot, this.leftHaunch, this.rightHaunch, this.body, this.leftFrontLeg, this.rightFrontLeg, this.tail)
                .forEach(p_103587_ -> p_103587_.render(pPoseStack, pBuffer, pPackedLight, pPackedOverlay, pRed, pGreen, pBlue, pAlpha));
            pPoseStack.popPose();
        } else {
            pPoseStack.pushPose();
            ...
            ImmutableList.of(
                ...
                .forEach(p_103572_ -> p_103572_.render(pPoseStack, pBuffer, pPackedLight, pPackedOverlay, pRed, pGreen, pBlue, pAlpha));
            pPoseStack.popPose();
        }
    }
