...
public class ItemListReport implements DataProvider {
    ...
    private static <T> JsonElement dumpComponent(TypedDataComponent<T> pComponent, DynamicOps<JsonElement> pOps) {
        ResourceLocation resourcelocation = BuiltInRegistries.DATA_COMPONENT_TYPE.getKey(pComponent.type());
        JsonElement jsonelement = pComponent.encodeValue(pOps)
