...
public class TrimPatterns {
    ...
    public static Optional<Holder.Reference<TrimPattern>> getFromTemplate(HolderLookup.Provider pRegistries, ItemStack pTemplate) {
        return pRegistries.lookupOrThrow(Registries.TRIM_PATTERN).listElements().filter(p_266833_ -> pTemplate.is(p_266833_.value().templateItem())).findFirst();
    }

    public static void register(BootstrapContext<TrimPattern> pContext, Item pTemplateItem, ResourceKey<TrimPattern> pTrimPatternKey) {
