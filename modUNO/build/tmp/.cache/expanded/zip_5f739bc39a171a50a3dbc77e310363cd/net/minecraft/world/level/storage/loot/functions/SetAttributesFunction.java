    ...
    public ItemStack run(ItemStack pStack, LootContext pContext) {
        if (this.replace) {
            ...
            pStack.update(
                ...
                p_327582_ -> p_327582_.modifiers().isEmpty() ? this.updateModifiers(pContext, pStack.getItem().getDefaultAttributeModifiers()) : this.updateModifiers(pContext, p_327582_)
            );
        }
