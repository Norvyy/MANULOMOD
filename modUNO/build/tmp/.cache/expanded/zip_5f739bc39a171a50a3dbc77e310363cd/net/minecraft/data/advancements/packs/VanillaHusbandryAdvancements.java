...
public class VanillaHusbandryAdvancements implements AdvancementSubProvider {
    ...
    public void generate(HolderLookup.Provider pRegistries, Consumer<AdvancementHolder> pWriter) {
        ...
        AdvancementHolder advancementholder1 = Advancement.Builder.advancement()
            ...
            .save(pWriter, "husbandry/plant_seed");
        AdvancementHolder advancementholder2 = Advancement.Builder.advancement()
            ...
            .save(pWriter, "husbandry/breed_an_animal");
        ...
        addFood(Advancement.Builder.advancement())
            ...
            .save(pWriter, "husbandry/balanced_diet");
        ...
        AdvancementHolder advancementholder3 = Advancement.Builder.advancement()
            ...
            .save(pWriter, "husbandry/tame_an_animal");
        AdvancementHolder advancementholder4 = addFish(Advancement.Builder.advancement())
            ...
            .save(pWriter, "husbandry/fishy_business");
        AdvancementHolder advancementholder5 = addFishBuckets(Advancement.Builder.advancement())
            ...
            .save(pWriter, "husbandry/tactical_fishing");
        AdvancementHolder advancementholder6 = Advancement.Builder.advancement()
            ...
            .save(pWriter, "husbandry/axolotl_in_a_bucket");
        Advancement.Builder.advancement()
            ...
            .save(pWriter, "husbandry/kill_axolotl_target");
        addCatVariants(Advancement.Builder.advancement())
            ...
            .save(pWriter, "husbandry/complete_catalogue");
        addTamedWolfVariants(Advancement.Builder.advancement(), pRegistries)
            .parent(advancementholder3)
            .display(
                Items.BONE,
            ...
            .rewards(AdvancementRewards.Builder.experience(50))
            .save(pWriter, "husbandry/whole_pack");
        AdvancementHolder advancementholder7 = Advancement.Builder.advancement()
            ...
            .save(pWriter, "husbandry/safely_harvest_honey");
        ...
        Advancement.Builder.advancement()
            ...
            .save(pWriter, "husbandry/wax_off");
        AdvancementHolder advancementholder9 = Advancement.Builder.advancement()
            ...
            .save(pWriter, "husbandry/tadpole_in_a_bucket");
        AdvancementHolder advancementholder10 = addLeashedFrogVariants(Advancement.Builder.advancement())
            ...
            .save(pWriter, "husbandry/leash_all_frog_variants");
        Advancement.Builder.advancement()
        ...
        Advancement.Builder.advancement()
            ...
            .save(pWriter, "husbandry/silk_touch_nest");
        Advancement.Builder.advancement()
            .parent(advancementholder)
            .display(
                Items.OAK_BOAT,
            ...
            .save(pWriter, "husbandry/ride_a_boat_with_a_goat");
        Advancement.Builder.advancement()
            .parent(advancementholder)
            .display(
                Items.GLOW_INK_SAC,
            ...
            .save(pWriter, "husbandry/make_a_sign_glow");
        AdvancementHolder advancementholder11 = Advancement.Builder.advancement()
            ...
            .save(pWriter, "husbandry/allay_deliver_item_to_player");
        Advancement.Builder.advancement()
            ...
            .save(pWriter, "husbandry/allay_deliver_cake_to_note_block");
        AdvancementHolder advancementholder12 = Advancement.Builder.advancement()
            ...
            .save(pWriter, "husbandry/obtain_sniffer_egg");
        AdvancementHolder advancementholder13 = Advancement.Builder.advancement()
            ...
            .save(pWriter, "husbandry/feed_snifflet");
        Advancement.Builder.advancement()
            ...
            .addCriterion("torchflower", ItemUsedOnLocationTrigger.TriggerInstance.placedBlock(Blocks.TORCHFLOWER_CROP))
            .addCriterion("pitcher_pod", ItemUsedOnLocationTrigger.TriggerInstance.placedBlock(Blocks.PITCHER_CROP))
            .save(pWriter, "husbandry/plant_any_sniffer_seed");
        Advancement.Builder.advancement()
            .parent(advancementholder3)
            .display(
                Items.SHEARS,
            ...
            .save(pWriter, "husbandry/remove_wolf_armor");
        Advancement.Builder.advancement()
            .parent(advancementholder3)
            .display(
                Items.WOLF_ARMOR,
            ...
            .save(pWriter, "husbandry/repair_wolf_armor");
    }

    public static AdvancementHolder createBreedAllAnimalsAdvancement(
        AdvancementHolder pParent, Consumer<AdvancementHolder> pWriter, Stream<EntityType<?>> pBreedableAnimals, Stream<EntityType<?>> pIndirectlyBreedableAnimals
    ) {
        return addBreedable(Advancement.Builder.advancement(), pBreedableAnimals, pIndirectlyBreedableAnimals)
            .parent(pParent)
            .display(
                Items.GOLDEN_CARROT,
    ...
    private static Advancement.Builder addLeashedFrogVariants(Advancement.Builder pBuilder) {
        BuiltInRegistries.FROG_VARIANT
            .holders()
            .forEach(
                p_325841_ -> pBuilder.addCriterion(
    ...
    private static Advancement.Builder addBreedable(Advancement.Builder pBuilder, Stream<EntityType<?>> pBreedableAnimals, Stream<EntityType<?>> pIndirectlyBreedableAnimals) {
        pBreedableAnimals.forEach(
            p_296350_ -> pBuilder.addCriterion(
        ...
        pIndirectlyBreedableAnimals.forEach(
            p_296346_ -> pBuilder.addCriterion(
