...
public class ExperienceCommand {
    ...
    static enum Type {
        POINTS("points", Player::giveExperiencePoints, (p_326256_, p_326257_) -> {
            if (p_326257_ >= p_326256_.getXpNeededForNextLevel()) {
                return false;
            } else {
                p_326256_.setExperiencePoints(p_326257_);
                return true;
            }
        }, p_326258_ -> Mth.floor(p_326258_.experienceProgress * (float)p_326258_.getXpNeededForNextLevel())),
