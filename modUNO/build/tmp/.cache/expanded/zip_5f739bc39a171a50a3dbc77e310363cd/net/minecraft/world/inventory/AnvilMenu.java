...
public class AnvilMenu extends ItemCombinerMenu {
    ...
    protected boolean mayPickup(Player pPlayer, boolean pHasStack) {
        return (pPlayer.hasInfiniteMaterials() || pPlayer.experienceLevel >= this.cost.get()) && this.cost.get() > 0;
    }
    ...
    protected void onTake(Player pPlayer, ItemStack pStack) {
        ...
        this.access.execute((p_150479_, p_150480_) -> {
            ...
            if (!pPlayer.hasInfiniteMaterials() && blockstate.is(BlockTags.ANVIL) && pPlayer.getRandom().nextFloat() < breakChance) {
