...
public class PiglinRenderer extends HumanoidMobRenderer<Mob, PiglinModel<Mob>> {
    ...
    public PiglinRenderer(
        EntityRendererProvider.Context pContext, ModelLayerLocation pLayer, ModelLayerLocation p_174346_, ModelLayerLocation p_174347_, boolean pNoRightEar
    ) {
        super(pContext, createModel(pContext.getModelSet(), pLayer, pNoRightEar), 0.5F, 1.0019531F, 1.0F, 1.0019531F);
        this.addLayer(
            new HumanoidArmorLayer<>(
                this, new HumanoidArmorModel(pContext.bakeLayer(p_174346_)), new HumanoidArmorModel(pContext.bakeLayer(p_174347_)), pContext.getModelManager()
            )
        );
    }
