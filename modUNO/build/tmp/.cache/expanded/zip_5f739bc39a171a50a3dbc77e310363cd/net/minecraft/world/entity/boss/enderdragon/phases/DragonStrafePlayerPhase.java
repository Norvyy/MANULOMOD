...
public class DragonStrafePlayerPhase extends AbstractDragonPhaseInstance {
    ...
    public DragonStrafePlayerPhase(EnderDragon pDragon) {
        super(pDragon);
    }
        ...
        if (this.attackTarget == null) {
            ...
            if (this.attackTarget.distanceToSqr(this.dragon) < 4096.0) {
                if (this.dragon.hasLineOfSight(this.attackTarget)) {
                    this.fireballCharge++;
                    Vec3 vec31 = new Vec3(this.attackTarget.getX() - this.dragon.getX(), 0.0, this.attackTarget.getZ() - this.dragon.getZ())
                        .normalize();
                    Vec3 vec3 = new Vec3(
                    ...
                    if (this.fireballCharge >= 5 && f >= 0.0F && f < 10.0F) {
                        ...
                        double d6 = this.dragon.head.getX() - vec32.x * 1.0;
                        double d7 = this.dragon.head.getY(0.5) + 0.5;
                        double d8 = this.dragon.head.getZ() - vec32.z * 1.0;
