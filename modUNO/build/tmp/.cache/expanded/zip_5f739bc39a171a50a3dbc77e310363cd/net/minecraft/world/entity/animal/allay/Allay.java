...
public class Allay extends PathfinderMob implements InventoryCarrier, VibrationSystem {
    ...
    protected void defineSynchedData(SynchedEntityData.Builder pBuilder) {
        ...
        pBuilder.define(DATA_DANCING, false);
        pBuilder.define(DATA_CAN_DUPLICATE, true);
    }
    ...
    class JukeboxListener implements GameEventListener {
        ...
        public boolean handleGameEvent(ServerLevel pLevel, Holder<GameEvent> pGameEvent, GameEvent.Context pContext, Vec3 pPos) {
            if (pGameEvent.is(GameEvent.JUKEBOX_PLAY)) {
                Allay.this.setJukeboxPlaying(BlockPos.containing(pPos), true);
                return true;
            } else if (pGameEvent.is(GameEvent.JUKEBOX_STOP_PLAY)) {
