...
public class TrialChambersStructurePools {
    ...
    public static void bootstrap(BootstrapContext<StructureTemplatePool> pContext) {
        ...
        Holder<StructureProcessorList> holder3 = holdergetter1.getOrThrow(UpdateOneTwentyOneProcessorLists.TRIAL_CHAMBERS_COPPER_BULB_DEGRADATION);
        pContext.register(
            START,
        ...
        Pools.register(
            ...
            new StructureTemplatePool(
                ...
                List.of(
                    ...
                    Pair.of(StructurePoolElement.single("trial_chambers/chamber/addon/full_column_ranged_spawner", holder3), 1),
                    Pair.of(StructurePoolElement.single("trial_chambers/chamber/addon/middle_column_ranged_spawner", holder3), 1),
