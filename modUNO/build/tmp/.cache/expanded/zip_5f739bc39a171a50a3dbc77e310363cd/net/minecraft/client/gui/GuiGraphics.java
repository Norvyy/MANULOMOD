...
public class GuiGraphics implements net.minecraftforge.client.extensions.IForgeGuiGraphics {
    ...
    public void fillRenderType(RenderType pRenderType, int pX1, int pY1, int pX2, int pY2, int pZ) {
        Matrix4f matrix4f = this.pose.last().pose();
        VertexConsumer vertexconsumer = this.bufferSource.getBuffer(pRenderType);
        vertexconsumer.vertex(matrix4f, (float)pX1, (float)pY1, (float)pZ).endVertex();
        vertexconsumer.vertex(matrix4f, (float)pX1, (float)pY2, (float)pZ).endVertex();
        vertexconsumer.vertex(matrix4f, (float)pX2, (float)pY2, (float)pZ).endVertex();
        vertexconsumer.vertex(matrix4f, (float)pX2, (float)pY1, (float)pZ).endVertex();
        this.flushIfUnmanaged();
    }
