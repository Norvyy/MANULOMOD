...
public class Gui {
    ...
    public void render(GuiGraphics pGuiGraphics, float pPartialTick) {
        ...
        this.layers.render(pGuiGraphics, pPartialTick);
    ...
    private void renderItemHotbar(GuiGraphics pGuiGraphics, float pPartialTick) {
    ...
    public void renderSelectedItemName(GuiGraphics pGuiGraphics, int yShift) {
        ...
        if (this.toolHighlightTimer > 0 && !this.lastToolHighlight.isEmpty()) {
            ...
            if (l > 0) {
                ...
                pGuiGraphics.drawString(this.getFont(), mutablecomponent, j, k, 16777215 + (l << 24));
    ...
    public void renderSavingIndicator(GuiGraphics pGuiGraphics, float pPartialTick) {
        if (this.minecraft.options.showAutosaveIndicator().get() && (this.autosaveIndicatorValue > 0.0F || this.lastAutosaveIndicatorValue > 0.0F)) {
            ...
            if (i > 8) {
                ...
                pGuiGraphics.drawString(font, SAVING_TEXT, pGuiGraphics.guiWidth() - j - 10, pGuiGraphics.guiHeight() - 15, k);
            }
        }
    }
