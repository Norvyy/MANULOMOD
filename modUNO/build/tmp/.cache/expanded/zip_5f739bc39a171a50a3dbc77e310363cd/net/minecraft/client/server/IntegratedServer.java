...
public class IntegratedServer extends MinecraftServer {
    ...
    @Override
    public void reportChunkLoadFailure(ChunkPos pChunkPos) {
        this.warnOnLowDiskSpace();
        SystemToast.onChunkLoadFailure(this.minecraft, pChunkPos);
    }

    @Override
    public void reportChunkSaveFailure(ChunkPos pChunkPos) {
        this.warnOnLowDiskSpace();
        SystemToast.onChunkSaveFailure(this.minecraft, pChunkPos);
    }
}
