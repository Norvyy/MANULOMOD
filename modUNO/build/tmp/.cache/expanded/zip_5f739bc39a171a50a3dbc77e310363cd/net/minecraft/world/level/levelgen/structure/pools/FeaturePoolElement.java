...
public class FeaturePoolElement extends StructurePoolElement {
    public static final MapCodec<FeaturePoolElement> CODEC = RecordCodecBuilder.mapCodec(
        p_210213_ -> p_210213_.group(PlacedFeature.CODEC.fieldOf("feature").forGetter(p_210215_ -> p_210215_.feature), projectionCodec())
                .apply(p_210213_, FeaturePoolElement::new)
    );
    ...
    public List<StructureTemplate.StructureBlockInfo> getShuffledJigsawBlocks(
        ...
        list.add(
            new StructureTemplate.StructureBlockInfo(
                pPos, Blocks.JIGSAW.defaultBlockState().setValue(JigsawBlock.ORIENTATION, FrontAndTop.fromFrontAndTop(Direction.DOWN, Direction.SOUTH)), this.defaultJigsawNBT
            )
        );
        return list;
    }
    ...
    public BoundingBox getBoundingBox(StructureTemplateManager pStructureTemplateManager, BlockPos pPos, Rotation pRotation) {
        ...
        return new BoundingBox(
            ...
            pPos.getY(),
            pPos.getZ(),
            pPos.getX() + vec3i.getX(),
            pPos.getY() + vec3i.getY(),
            pPos.getZ() + vec3i.getZ()
        );
    }
    ...
    public boolean place(
        ...
        return this.feature.value().place(pLevel, pGenerator, pRandom, pOffset);
    }
