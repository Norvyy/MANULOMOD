...
public class SkinReportScreen extends AbstractReportScreen<SkinReport.Builder> {
    ...
    protected void init() {
        ...
        this.selectReasonButton = Button.builder(
                SELECT_REASON, p_299380_ -> this.minecraft.setScreen(new ReportReasonSelectionScreen(this, this.reportBuilder.reason(), p_299180_ -> {
        ...
        linearlayout2.addChild(Button.builder(CommonComponents.GUI_BACK, p_325409_ -> this.onClose()).width(120).build());
        this.sendButton = linearlayout2.addChild(Button.builder(SEND_REPORT, p_325408_ -> this.sendReport()).width(120).build());
        this.layout.visitWidgets(p_325407_ -> {
            AbstractWidget abstractwidget = this.addRenderableWidget(p_325407_);
        });
