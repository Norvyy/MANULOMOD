...
public class BannerPatternFormatFix extends NamedEntityFix {
    ...
    protected Typed<?> fix(Typed<?> pTyped) {
        return pTyped.update(DSL.remainderFinder(), BannerPatternFormatFix::fixTag);
    }
    ...
    private static Dynamic<?> fixLayer(Dynamic<?> p_333413_) {
        ...
        return p_333413_.renameAndFixField("Color", "color", p_335083_ -> p_335083_.createString(fixColor(p_335083_.asInt(0))));
    }
