...
public class GoatAi {
    ...
    private static final TargetingConditions RAM_TARGET_CONDITIONS = TargetingConditions.forCombat()
        .selector(p_326995_ -> !p_326995_.getType().equals(EntityType.GOAT) && p_326995_.level().getWorldBorder().isWithinBounds(p_326995_.getBoundingBox()));
            ...
            ImmutableList.of(
                Pair.of(
                    ...
                    new RamTarget(
                        ...
                        3.0F,
                        p_326993_ -> p_326993_.isBaby() ? 1.0 : 2.5,
