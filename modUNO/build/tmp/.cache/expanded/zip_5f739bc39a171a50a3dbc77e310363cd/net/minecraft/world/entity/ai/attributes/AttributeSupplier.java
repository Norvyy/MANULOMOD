...
public class AttributeSupplier {
    ...
    public double getModifierValue(Holder<Attribute> pAttribute, UUID pUuid) {
        AttributeModifier attributemodifier = this.getAttributeInstance(pAttribute).getModifier(pUuid);
        if (attributemodifier == null) {
            throw new IllegalArgumentException("Can't find modifier " + pUuid + " on attribute " + pAttribute.getRegisteredName());
        } else {
    ...
    public boolean hasModifier(Holder<Attribute> pAttribute, UUID pUuid) {
        AttributeInstance attributeinstance = this.instances.get(pAttribute);
        return attributeinstance != null && attributeinstance.getModifier(pUuid) != null;
    }
