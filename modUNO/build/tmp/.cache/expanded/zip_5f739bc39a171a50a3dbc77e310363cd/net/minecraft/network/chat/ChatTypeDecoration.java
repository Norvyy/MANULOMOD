...
public record ChatTypeDecoration(String translationKey, List<ChatTypeDecoration.Parameter> parameters, Style style) {
    ...
    public static enum Parameter implements StringRepresentable {
        ...
        TARGET("target", (p_326059_, p_326060_) -> p_326060_.targetName().orElse(CommonComponents.EMPTY)),
        ...
        private Parameter(final String pName, final ChatTypeDecoration.Parameter.Selector pSelector) {
            this.name = pName;
