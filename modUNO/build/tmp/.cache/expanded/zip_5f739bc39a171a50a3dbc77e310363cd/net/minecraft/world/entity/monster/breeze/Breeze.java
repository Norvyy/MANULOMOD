...
public class Breeze extends Monster {
    ...
    private static final ProjectileDeflection PROJECTILE_DEFLECTION = (p_331050_, p_333637_, p_328921_) -> {
        p_333637_.level().playLocalSound(p_333637_, SoundEvents.BREEZE_DEFLECT, p_333637_.getSoundSource(), 1.0F, 1.0F);
    ...
    public ProjectileDeflection deflection(Projectile pProjectile) {
        return pProjectile.getType() != EntityType.BREEZE_WIND_CHARGE && pProjectile.getType() != EntityType.WIND_CHARGE ? PROJECTILE_DEFLECTION : ProjectileDeflection.NONE;
    }
