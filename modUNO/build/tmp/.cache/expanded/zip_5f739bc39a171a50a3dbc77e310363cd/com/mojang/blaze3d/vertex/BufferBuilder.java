...
public class BufferBuilder extends DefaultedVertexConsumer implements BufferVertexConsumer {
    ...
    private IntConsumer intConsumer(int pNextElementByte, VertexFormat.IndexType pIndexType) {
        ...
        return switch (pIndexType) {
            case SHORT -> p_231167_ -> this.buffer.putShort(mutableint.getAndAdd(2), (short)p_231167_);
            case INT -> p_231163_ -> this.buffer.putInt(mutableint.getAndAdd(4), p_231163_);
        };
    }
    ...
    private BufferBuilder.RenderedBuffer storeRenderedBuffer() {
        ...
        BufferBuilder.DrawState bufferbuilder$drawstate = new BufferBuilder.DrawState(
            this.format, this.vertices, i, this.mode, vertexformat$indextype, this.indexOnly, flag
        );
    ...
    public class RenderedBuffer {
        ...
        RenderedBuffer(final int pPointer, final BufferBuilder.DrawState pDrawState) {
