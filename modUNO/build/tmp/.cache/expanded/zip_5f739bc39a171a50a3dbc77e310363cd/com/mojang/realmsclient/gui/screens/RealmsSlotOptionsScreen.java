...
public class RealmsSlotOptionsScreen extends RealmsScreen {
    ...
    public void init() {
        ...
        this.addRenderableWidget(
            Button.builder(CommonComponents.GUI_CANCEL, p_280758_ -> this.minecraft.setScreen(this.parent))
                .bounds(i, row(13), this.columnWidth, 20)
                .build()
        );
    }
    ...
    public void render(GuiGraphics pGuiGraphics, int pMouseX, int pMouseY, float pPartialTick) {
        ...
        pGuiGraphics.drawString(this.font, NAME_LABEL, this.column1X + this.columnWidth / 2 - this.font.width(NAME_LABEL) / 2, row(0) - 5, -1, false);
