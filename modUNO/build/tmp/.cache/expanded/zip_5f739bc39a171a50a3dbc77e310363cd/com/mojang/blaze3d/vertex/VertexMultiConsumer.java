...
public class VertexMultiConsumer {
    ...
    static class Double implements VertexConsumer {
        ...
        public void vertex(
            ...
            this.first
                .vertex(
                    pX, pY, pZ, pRed, pGreen, pBlue, pAlpha, pTexU, pTexV, pOverlayUV, pLightmapUV, pNormalX, pNormalY, pNormalZ
                );
            this.second
                .vertex(
                    pX, pY, pZ, pRed, pGreen, pBlue, pAlpha, pTexU, pTexV, pOverlayUV, pLightmapUV, pNormalX, pNormalY, pNormalZ
    ...
    static class Multiple implements VertexConsumer {
        ...
        @Override
        public VertexConsumer vertex(double pX, double pY, double pZ) {
            this.forEach(p_167082_ -> p_167082_.vertex(pX, pY, pZ));
            return this;
        }

        @Override
        public VertexConsumer color(int pRed, int pGreen, int pBlue, int pAlpha) {
            this.forEach(p_167163_ -> p_167163_.color(pRed, pGreen, pBlue, pAlpha));
            return this;
        }

        @Override
        public VertexConsumer uv(float pU, float pV) {
            this.forEach(p_167125_ -> p_167125_.uv(pU, pV));
            return this;
        }

        @Override
        public VertexConsumer overlayCoords(int pU, int pV) {
            this.forEach(p_167167_ -> p_167167_.overlayCoords(pU, pV));
            return this;
        }

        @Override
        public VertexConsumer uv2(int pU, int pV) {
            this.forEach(p_167143_ -> p_167143_.uv2(pU, pV));
            return this;
        }

        @Override
        public VertexConsumer normal(float pX, float pY, float pZ) {
            this.forEach(p_167121_ -> p_167121_.normal(pX, pY, pZ));
            return this;
        }
        ...
        @Override
        public void defaultColor(int pDefaultR, int pDefaultG, int pDefaultB, int pDefaultA) {
            this.forEach(p_167139_ -> p_167139_.defaultColor(pDefaultR, pDefaultG, pDefaultB, pDefaultA));
        }
